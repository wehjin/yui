use yui::{AfterFlow, ArcYard, Cling, Confine, Create, Flow, Padding, SenderLink, Spark, yard, Before};
...
impl Spark for SelectorListDemo {
    ...
    fn render(state: &Self::State, link: &SenderLink<Self::Action>) -> Option<ArcYard> {
        ...
        let body =
            yard::list(LIST_ID, value as usize - 1, items)
                .before(yard::fill(FillColor::Side, FillGrade::Plain))
                .confine_width(40, Cling::Center);
        let page = tab_page(
            body,
            2,
